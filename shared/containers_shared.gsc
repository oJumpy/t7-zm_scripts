...
function private autoexec cContainer()
{
	...
	classes.cContainer[0].__vtable[1606033458] = &cContainer::function_5fba2032;
	classes.cContainer[0].__vtable[-1690805083] = &cContainer::function_9b385ca5;
}
...
function setup_general_container_bundle(str_targetname, str_intel_vo, str_narrative_collectable_model, force_open)
{
	...
	else if(isdefined(str_narrative_collectable_model))
	{
