...
function function_c291114d()
{
	...
	/#
		...
		else if(level flag::exists("Dev Block strings are not supported"))
		{
...
function function_29d15688()
{
	/#
		...
		{
			debug = GetDvarInt("Dev Block strings are not supported");
			if(debug !== 0 && debug !== 3)
			{
				wait(0.05);
				return;
...
function function_1679e5f0()
{
	...
	{
		/#
			nospawn = GetDvarInt("Dev Block strings are not supported");
			if(nospawn)
			{
				wait(3);
				continue;
...
function function_6e418eff(var_56d259ba)
{
	...
	else if(var_56d259ba == "raz" || var_56d259ba == "zombie")
	{
		if(isdefined(level.var_5fe02c5a))
		{
...
function function_934917cc(e_inflictor, str_mod, w_weapon)
{
	...
	else if(w_weapon === self.var_70fcb15a)
	{
