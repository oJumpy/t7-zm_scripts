...
function __main__()
{
	/#
		...
		level scene::add_scene_func("Dev Block strings are not supported", &function_7e02b332, "Dev Block strings are not supported", 0);
		level scene::add_scene_func("Dev Block strings are not supported", &function_7e02b332, "Dev Block strings are not supported", 1);
	#/
...
{
	var_c3b99253 = StrTok(str_key, "_");
	return var_c3b99253[6];
}
...
function function_72dd3113()
{
	...
	/#
		...
		{
			var_385ae3a2 zm_unitrigger::create_unitrigger("Dev Block strings are not supported");
		}
	#/
	var_78d02c88 = GetEnt("ee_map_shelf", "targetname");
...
function function_3d77d2aa()
{
	...
	do
	{
		...
		foreach(var_ad364454 in var_fa839427)
		{
...
{
	/#
		level.var_8b2f7f24 = "Dev Block strings are not supported";
	...
	#/
	level dragon::function_1b58252d();
...
function function_c324c7f6()
{
	while(1)
	{
		var_15b740f0 = Array::random(level.var_583e4a97.var_4dfc9f38);
		...
		switch(var_181d95e)
		{
			case "library":
			{
				if(var_15b740f0.script_string != "ee_library")
				{
					return var_15b740f0;
				}
				break;
			...
			case "factory":
			{
				if(var_15b740f0.script_string != "ee_factory")
				{
					return var_15b740f0;
				}
				break;
			...
			case "judicial":
			{
				if(var_15b740f0.script_string != "ee_command")
				{
					return var_15b740f0;
				}
				break;
...
function function_f5139aae()
{
	...
	if(level namespace_8bc21961::function_19d0b055(1, &function_de888a13, 1, var_6ea4ef96))
	{
...
function function_a9a92838()
{
	...
	while(1)
	{
		var_6de069e0 = self namespace_48c05c81::function_1af75b1b(200);
		if(var_6de069e0 && !var_9c0d91a)
		{
			var_9c0d91a = 1;
			self vehicle::resume_path();
			self notify("hash_3751c122");
		}
		else if(!var_6de069e0 && var_9c0d91a)
		{
			var_9c0d91a = 0;
			self vehicle::pause_path();
			self thread function_8c3c41dc();
...
function function_18375f27(var_4af7b97)
{
	...
	/#
		...
		{
			var_385ae3a2 = struct::get("Dev Block strings are not supported", "Dev Block strings are not supported");
			level.var_f0d11538 = spawn("Dev Block strings are not supported", var_385ae3a2.origin);
		}
	#/
	level.var_f0d11538 playsound("zmb_scenarios_map_scenario_select");
	for(i = 0; i < 4; i++)
...
function function_94d0ca21()
{
	...
	var_7a05a0de = util::spawn_model("p7_zm_ctl_keycard_ee", var_b465a89c + (-5, 0, -2), VectorScale((1, 0, 0), 90));
	var_7a05a0de LinkTo(var_78d02c88, "wall_map_shelf_door");
	var_78d02c88 scene::Play("p7_fxanim_zm_stal_wall_map_drawer_open_bundle", var_78d02c88);
	level thread function_978eeda3();
	var_7a05a0de function_6e3a6092(100, &"ZM_STALINGRAD_KEY_CARD");
	level notify("hash_b9c7ec1b");
	var_7a05a0de playsound("zmb_scenario_torrent_key_grab");
	var_7a05a0de delete();
...
function function_978eeda3()
{
	...
	{
		wait(30);
		level thread namespace_dcf9c464::function_e4acaa37("vox_soph_data_take_disk_" + n_nag + "_0");
	}
}
...
function function_8e92625b()
{
	...
	while(1)
	{
		...
		if(isdefined(var_46273a16.var_ef53764e) && var_46273a16.var_ef53764e)
		{
			...
			var_46273a16.var_7a05a0de = util::spawn_model("p7_zm_ctl_keycard_ee", var_46273a16.origin + (0.25, 13, -14.75), var_46273a16.angles + VectorScale((1, -1, 0), 90));
			var_46273a16.var_7a05a0de playsound("zmb_scenario_torrent_key_insert");
			var_46273a16.var_7a05a0de MoveY(4, 1);
		}
		var_46273a16.var_7a05a0de playsound("zmb_scenarios_button_activate");
...
function function_600265ae()
{
	...
	var_46273a16.var_7a05a0de playsound("zmb_scenario_torrent_key_grab");
	var_46273a16.var_7a05a0de delete();
...
function function_6199ca7e()
{
	...
	while(1)
	{
		var_c221db1d = level.var_cd867f7a / level.var_2cd0f4a0;
		if(var_c221db1d < 0)
		{
			var_c221db1d = 0;
		}
		...
		self.useBar hud::updateBar(var_c221db1d);
		wait(0.05);
	}
}
...
{
	var_20f77c4b = GetEnt("robot_head_clocktower", "targetname");
	var_2e8d47d3 = var_20f77c4b.angles;
	var_86cbea2c = var_2e8d47d3 + (0, -28, -50);
	var_20f77c4b RotateTo(var_86cbea2c, 3, 0.5, 0.1);
	var_20f77c4b playsound("zmb_robo_eye_head_move");
	var_20f77c4b waittill("rotatedone");
	var_20f77c4b playsound("zmb_robo_eye_head_start");
	var_20f77c4b PlayLoopSound("zmb_robo_eye_head_lp", 1.5);
	exploder::exploder("fxexp_700");
	wait(5);
	exploder::stop_exploder("fxexp_700");
	var_20f77c4b playsound("zmb_robo_eye_head_stop");
	var_20f77c4b StopLoopSound(1);
	wait(1);
	var_20f77c4b RotateTo(var_2e8d47d3, 3, 0.5, 0.1);
	var_20f77c4b playsound("zmb_robo_eye_head_move");
	wait(1);
}
...
function function_d9d36a17(STR_MODEL, str_hint, v_angles, var_c991b769)
{
	...
	while(!level.var_a090a655 namespace_48c05c81::function_1af75b1b(250))
	{
		wait(0.5);
	}
...
{
	/#
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_4fdd3e35);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_2ce0ea3d);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_96a879de);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_453d1020);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_43beec5a);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_5879102a);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_2be548b9);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_8265c377);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_da01ea0);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_d95ba8e4);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_81799b1b);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_15b02c6d);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_f8be6f86);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_126d3a92);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_1b02c173);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_98be294);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_90a2468c);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_63ef4ccd);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_474a5f0);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_d810756e);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_400ba4a5);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_c25033fa);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_e6dcb4c9);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_e7aa9b86);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_9d07a3ef);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_67c46c97);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_bbf6c2d0);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_22557cc3);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_3de60ba3);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_4f92d875);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_9b3c25cd);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_ff112fdc);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_5446a1da);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_10f1fb15);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_9cde71dd);
		level thread function_a1f6ef06("Dev Block strings are not supported", "Dev Block strings are not supported", 1, &function_bd5b4406);
	#/
}
...
function function_98be294(n_value)
{
	/#
		...
		{
			level.var_9f752812 thread zm_utility::print3d_ent("Dev Block strings are not supported", (0, 1, 0), 3, VectorScale((0, 0, 1), 24));
		}
	#/
}
...
function function_1b02c173(n_value)
{
	/#
		if(isdefined(level.var_a5fb1d00))
		{
			...
			level.var_a5fb1d00 thread zm_utility::print3d_ent("Dev Block strings are not supported", (0, 1, 0), 3, VectorScale((0, 0, 1), 24));
		}
	#/
}
...
{
	/#
		var_4af7b97 = Array("Dev Block strings are not supported", "Dev Block strings are not supported", "Dev Block strings are not supported", "Dev Block strings are not supported", "Dev Block strings are not supported", "Dev Block strings are not supported");
		var_4af7b97 = Array::randomize(var_4af7b97);
		level function_18375f27(var_4af7b97);
	#/
}
...
{
	/#
		level.var_c47b244 = function_c5c5f391("Dev Block strings are not supported", 1);
	#/
}
...
{
	/#
		level.var_c47b244 = function_c5c5f391("Dev Block strings are not supported", 2);
	#/
}
...
{
	/#
		var_afe8026c = struct::get_array("Dev Block strings are not supported", "Dev Block strings are not supported");
		foreach(var_15b740f0 in var_afe8026c)
		{
			if(var_15b740f0.script_string == str_location && var_15b740f0.script_int == var_d858aeb5)
			{
				return var_15b740f0;
			}
		}
...
{
	/#
		var_fc275254 = "Dev Block strings are not supported" + level.var_8b2f7f24 + "Dev Block strings are not supported";
...
function function_22557cc3(n_value)
{
	/#
		...
		level thread namespace_dcf9c464::function_ea234d37();
		level waittill("hash_34e4b03f");
		level.var_a090a655 scene::Play("Dev Block strings are not supported");
	#/
}
...
{
	/#
		var_7953b28 = GetEntArray("Dev Block strings are not supported", "Dev Block strings are not supported");
		foreach(var_c2d73a21 in var_7953b28)
		{
...
{
	/#
		self scene::Play("Dev Block strings are not supported", Array(self));
		wait(5);
		self scene::Play("Dev Block strings are not supported", Array(self));
	#/
}
...
{
	/#
		var_55471a18 = struct::get("Dev Block strings are not supported", "Dev Block strings are not supported");
		var_663b2442 = zombie_utility::spawn_zombie(level.var_fda4b3f3[0], "Dev Block strings are not supported", var_55471a18);
		var_663b2442 vehicle_ai::set_state("Dev Block strings are not supported");
...
function function_9b3c25cd(n_value)
{
	/#
		var_55471a18 = struct::get("Dev Block strings are not supported", "Dev Block strings are not supported");
		var_1c963231 = zombie_utility::spawn_zombie(level.var_6bca5baa[0], "Dev Block strings are not supported", var_55471a18);
...
function function_a1f6ef06(str_devgui_path, str_dvar, n_value, func, n_base_value)
{
	/#
		...
		str_devgui_path = "Dev Block strings are not supported" + str_devgui_path;
