...
function function_47ecaed4(localClientNum)
{
	level.var_ff4acd38 = [];
	i = 0;
	for(var_8c9a6a50 = GetEnt(localClientNum, "lighthouse_light_ring_1", "targetname"); isdefined(var_8c9a6a50);  = GetEnt(localClientNum, "lighthouse_light_ring_1", "targetname"))
	{
