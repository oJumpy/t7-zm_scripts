...
{
	var_bc5cda7b = self util::waittill_any_return("bgb_eye_candy_activation", "end_game", "bgb_gumball_anim_give", "disconnect", "bled_out");
	visionset_mgr::deactivate("visionset", str_vision, self);
	visionset_mgr::deactivate("overlay", str_vision, self);
	if(var_bc5cda7b !== "bgb_eye_candy_activation" || self.var_e20073c4 >= 4)
	{
