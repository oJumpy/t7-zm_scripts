...
function function_53f26a4c()
{
	...
	if(self.var_bb2fd41c === 3)
	{
		foreach(var_5972e249 in level.var_769c0729)
		{
			...
			{
				var_5972e249 function_cb2c15eb(self, &"ZOMBIE_ELECTRIC_SWITCH");
			}
		}
		break;
	}
	if(self.var_bb2fd41c > 0)
	{
		foreach(var_5972e249 in level.var_769c0729)
		{
			if(isdefined(var_5972e249))
			{
				var_5972e249 function_cb2c15eb(self, &"ZM_ISLAND_POWER_SWITCH_NEEEDS_MORE_WATER");
			}
		}
		break;
	}
	foreach(var_5972e249 in level.var_769c0729)
	{
		if(isdefined(var_5972e249))
		{
			var_5972e249 function_cb2c15eb(self, &"ZM_ISLAND_POWER_SWITCH_NEEEDS_WATER");
		}
	}
}
...
function function_83ead54e()
{
	/#
		...
		level flag::set("Dev Block strings are not supported" + 4);
	#/
}
	...
	while(1)
	{
		...
		while(1)
		{
			...
			if(self.script_int === 1)
			{
				...
				/#
					println("Dev Block strings are not supported" + e_who.var_c6cad973);
				#/
			}
			else
			{
...
function function_3e519f17()
{
	...
	while(1)
	{
		...
		/#
			...
			{
				println("Dev Block strings are not supported" + e_who.playerNum + "Dev Block strings are not supported");
			}
		#/
	}
}
	...
	while(1)
	{
		...
		if(e_player useButtonPressed())
		{
			...
			if(isdefined(e_player.var_57db2550) && e_player.var_7621b9dd - e_player.var_57db2550 > 250)
			{
				...
				/#
					println("Dev Block strings are not supported" + e_player.playerNum + "Dev Block strings are not supported");
				#/
			}
		}
	}
...
{
	/#
		zm_devgui::function_4acecab5(&function_d8d81d72);
	...
	/#
		switch(cmd)
		{
			case "Dev Block strings are not supported":
			{
				...
				{
					if(player clientfield::get_to_player("Dev Block strings are not supported"))
					{
						continue;
					}
					player clientfield::set_to_player("Dev Block strings are not supported", 1);
...
{
	/#
		var_5646068 = struct::get_array("Dev Block strings are not supported", "Dev Block strings are not supported");
