...
function function_a2209df2(e_player, var_307bab92, var_c807e383, v_up, var_5c44718b, var_8f0f462c)
{
	...
	if(isdefined(var_8f0f462c))
	{
		...
		var_307bab92 = var_307bab92 - (0, 0, 0) * 2;
		...
		if(var_20d031ed > 32)
		{
			...
			if(var_72027ac3 > 0)
			{
				...
				var_bc5cda7b = var_28388a90 util::waittill_any_return("movedone", "mechz_impact");
			}
			if(var_bc5cda7b != "mechz_impact" && var_5c44718b)
			{
...
function function_4f87899e(var_307bab92, var_c807e383, v_up, var_5c44718b)
{
	...
	if(var_5c44718b)
	{
		foreach(var_3c5572a7 in self.var_ce6323c7)
		{
	...
	else if(isdefined(var_3c9168a7))
	{
		...
		if(var_7478bee7.size)
		{
			...
			foreach(ai_enemy in var_7478bee7)
			{
				...
				if(zm_utility::is_player_valid(e_player) && (level.round_number < 26 || (level.round_number >= 26 && DistanceSquared(e_player.origin, ai_enemy.origin) < var_7839cab3)))
				{
					...
					if(var_ffc350c5[1] - var_a90ad319[1] > 0)
					{
					}
					else
					{
...
function function_88bf0c4e(e_player, n_damage, v_hit_origin, weapon)
{
	...
	else
	{
		...
		while(var_55e8a42 > 0.7)
		{
			...
			if(var_55e8a42 < self.var_ec71e17a)
			{
			}
			else
			{
			}
			self.var_ec71e17a = self.var_ec71e17a;
