...
function function_fbea6a64(e_player)
{
	...
	else if(level flag::get("lockdown_active") && self.stub.script_noteworthy !== "street_flinger")
	{
		self setHintString(&"ZM_STALINGRAD_FLINGER_DISABLED");
		return 0;
	}
	else if(isdefined(self.stub.var_66a9cd70) && self.stub.var_66a9cd70)
	{
	...
	else if(self.stub.var_dd690f31 === 0)
	{
