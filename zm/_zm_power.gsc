...
function revert_power(delta, origin, radius, powered_list)
{
	if(delta > 0)
	{
		self.depowered_count--;
		/#
			Assert(self.depowered_count >= 0, "Dev Block strings are not supported");
		#/
	...
	else if(delta < 0)
	{
		self.powered_count--;
		/#
			Assert(self.powered_count >= 0, "Dev Block strings are not supported");
		#/
...
function add_local_power(origin, radius)
{
	...
	/#
		println("Dev Block strings are not supported" + origin + "Dev Block strings are not supported" + radius + "Dev Block strings are not supported");
	#/
...
{
	/#
		println("Dev Block strings are not supported" + localpower.origin + "Dev Block strings are not supported" + localpower.radius + "Dev Block strings are not supported");
	#/
	if(isdefined(localpower.enabled_list))
	{
...
{
	/#
		println("Dev Block strings are not supported" + self.target zm_perks::getVendingMachineNotify() + "Dev Block strings are not supported");
	#/
...
function perk_power_off(origin, radius)
{
	...
	/#
		println("Dev Block strings are not supported" + self.target.script_noteworthy + "Dev Block strings are not supported");
	#/
