...
function do_cleanup_check(n_override_cleanup_dist)
{
	...
	if(!b_in_active_zone)
	{
		...
		{
			self thread function_34478a90();
		}
	}
}

/*
	Name: function_34478a90
	Namespace: namespace_f09ec4f7
	Checksum: 0x216E4666
	Offset: 0x728
	Size: 0x3CB
	...
	Flags: None
*/
function function_34478a90(var_1503b3f8)
{
	...
	else if(!(isdefined(self.exclude_cleanup_adding_to_total) && self.exclude_cleanup_adding_to_total))
	{
		level.zombie_total++;
