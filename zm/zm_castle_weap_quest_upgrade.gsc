...
function function_7a965585()
{
	/#
		...
		{
			level thread scene::init("Dev Block strings are not supported");
			level.var_714fae39 = 0;
		}
		else
		{
...
function function_c272bd2a()
{
	/#
		...
		level clientfield::set("Dev Block strings are not supported", function_85bfa3fd(level.var_c62829c7.characterindex));
		...
		var_a462d6ee = struct::get("Dev Block strings are not supported");
...
function function_ab3e9362()
{
	/#
		wait(8);
		level.var_2b11065e = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
		level.var_2b11065e Hide();
	#/
}

/*
	Name: function_c2de3b2b
	Namespace: namespace_99cb5531
	Checksum: 0x95B8112A
	Offset: 0x4198
	Size: 0x253
...
function function_3d19bfe5()
{
	/#
		...
		level endon("hash_c2de3b2b");
		var_94f11108 = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
		var_8b1b34fc = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
		var_ca72ca5f = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
		if(!isdefined(var_94f11108) || !isdefined(var_8b1b34fc) || !isdefined(var_ca72ca5f))
		{
			return;
		}
		var_94f11108 clientfield::set("Dev Block strings are not supported", 1);
		var_8b1b34fc clientfield::set("Dev Block strings are not supported", 1);
		var_ca72ca5f clientfield::set("Dev Block strings are not supported", 1);
		wait(0.05);
		var_94f11108 clientfield::set("Dev Block strings are not supported", 0);
		exploder::exploder("Dev Block strings are not supported");
		wait(1);
		var_8b1b34fc clientfield::set("Dev Block strings are not supported", 0);
		exploder::exploder("Dev Block strings are not supported");
		wait(7.5);
		exploder::stop_exploder("Dev Block strings are not supported");
		var_ca72ca5f clientfield::set("Dev Block strings are not supported", 0);
		var_94f11108 clientfield::set("Dev Block strings are not supported", 1);
	#/
}
...
{
	/#
		var_a717e964 = GetEntArray("Dev Block strings are not supported", "Dev Block strings are not supported");
		...
		var_9877e371 = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
		if(isdefined(var_9877e371))
		{
			var_9877e371 moveto((210, 1920, 1532), 0.5);
		}
		level scene::Play("Dev Block strings are not supported");
		level scene::Play("Dev Block strings are not supported");
	#/
}
...
function function_6c9ecb6()
{
	/#
		...
		{
			level scene::skipto_end("Dev Block strings are not supported");
			level thread scene::Play("Dev Block strings are not supported");
		}
		level flag::set("Dev Block strings are not supported");
		level flag::set("Dev Block strings are not supported");
		...
		var_b4df6e91 = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
...
{
	/#
		if(level flag::get("Dev Block strings are not supported") || level flag::get("Dev Block strings are not supported"))
		{
			return;
		}
		var_effd0eae = GetEntArray("Dev Block strings are not supported", "Dev Block strings are not supported");
		foreach(var_6f4e5e57 in var_effd0eae)
		{
			if(!level flag::get("Dev Block strings are not supported"))
			{
			...
			var_6f4e5e57 flag::set("Dev Block strings are not supported");
		}
		level flag::set("Dev Block strings are not supported");
	#/
}
...
function function_6de95813()
{
	/#
		...
		zm_spawner::deregister_zombie_death_event_callback(&function_2da80856);
		var_42d1b62e = GetEntArray("Dev Block strings are not supported", "Dev Block strings are not supported");
		foreach(var_9c1f46d7 in var_42d1b62e)
		{
			var_9c1f46d7 clientfield::set("Dev Block strings are not supported", 1);
			var_9c1f46d7 clientfield::set("Dev Block strings are not supported", 0);
		}
		var_11307e05 = GetEntArray("Dev Block strings are not supported", "Dev Block strings are not supported");
		foreach(var_92fe416a in var_11307e05)
		{
			var_92fe416a clientfield::set("Dev Block strings are not supported", 1);
		}
		level flag::set("Dev Block strings are not supported");
	#/
}
...
function function_1ae3933d(var_eae04066, var_99857f04)
{
	...
	var_9877e371 = GetEnt("aq_rp_magma_ball_tag", "targetname");
	var_b35375be = util::spawn_model("tag_origin", var_a7b8686c);
	var_b35375be clientfield::set("runeprison_rock_fx", 1);
	var_d59b9592 = spawn("trigger_radius", var_a7b8686c, 0, 100, 150);
	var_d59b9592.var_41f52afd = var_b35375be;
...
/*
	...
	Flags: None
*/
function function_a78192b2(var_b35375be)
{
	var_b35375be clientfield::set("runeprison_rock_fx", 0);
	wait(6);
	var_b35375be delete();
}
...
{
	/#
		var_2716c17 = struct::get_array("Dev Block strings are not supported", "Dev Block strings are not supported");
		if(isdefined(level.var_ca9bb3ac) && level.var_ca9bb3ac)
		{
			foreach(var_99857f04 in var_2716c17)
			{
				var_99857f04.var_197f1988 scene::stop("Dev Block strings are not supported");
			}
			exploder::stop_exploder("Dev Block strings are not supported");
			exploder::stop_exploder("Dev Block strings are not supported");
			exploder::stop_exploder("Dev Block strings are not supported");
		...
		else
		{
			foreach(var_99857f04 in var_2716c17)
			{
				...
				{
					var_99857f04.var_197f1988 = util::spawn_model("Dev Block strings are not supported", var_99857f04.origin + (36, 88, 12));
				}
				var_99857f04.var_197f1988 thread scene::Play("Dev Block strings are not supported");
			}
			exploder::exploder("Dev Block strings are not supported");
			exploder::exploder("Dev Block strings are not supported");
			exploder::exploder("Dev Block strings are not supported");
...
function function_e09edb0()
{
	/#
		...
		var_11307e05 = GetEntArray("Dev Block strings are not supported", "Dev Block strings are not supported");
		Array::thread_all(var_11307e05, &function_561d0d99);
		var_e92aafe5 = GetEntArray("Dev Block strings are not supported", "Dev Block strings are not supported");
		Array::run_all(var_e92aafe5, &delete);
		var_e35d5b6e = struct::get("Dev Block strings are not supported", "Dev Block strings are not supported");
		if(isdefined(var_e35d5b6e.var_7b98b639))
		{
			var_e35d5b6e.var_7b98b639 delete();
		}
...
function function_e83bfb3()
{
	/#
		...
		{
			var_9dc11e80 = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
			var_9dc11e80 show();
			level thread scene::Play("Dev Block strings are not supported");
			level.var_1e2db323 = 1;
		}
...
function function_d4533e0c()
{
	/#
		wait(2);
		var_5669be5f = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
		var_5669be5f delete();
	#/
}
...
function function_44605b46()
{
	/#
		...
		var_28eeb81a = struct::get("Dev Block strings are not supported", "Dev Block strings are not supported");
		...
		level function_f5e9876("Dev Block strings are not supported", 6);
		...
		level flag::set("Dev Block strings are not supported");
		var_28eeb81a.var_d4a62e6b = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
		var_28eeb81a thread function_fb704679();
		level function_2c1c1d3e("Dev Block strings are not supported");
	#/
}

/*
	Name: function_18251dec
	Namespace: namespace_99cb5531
	Checksum: 0x7E391EC6
	Offset: 0x8698
	Size: 0x2D3
...
function function_4e281784()
{
	/#
		...
		if(!(isdefined(level.var_67c3233f) && level.var_67c3233f))
		{
			...
			level.var_67c3233f = 1;
			wait(0.05);
			level.var_72a6d56b = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
			level.var_72a6d56b Hide();
		}
		level thread namespace_2a78f3c::function_a01a53de();
		level.var_6e68c0d8 = level.players[0];
		level clientfield::set("Dev Block strings are not supported", function_85bfa3fd(level.var_6e68c0d8.characterindex));
		level.var_427e7668[level.var_427e7668.size] = level.players[0];
		level flag::set("Dev Block strings are not supported");
	#/
}
...
function function_c0165d14()
{
	/#
		...
		{
			level.var_8ead83b4 = level flag::get("Dev Block strings are not supported");
		}
...
function function_ff914e7a()
{
	/#
		...
		exploder::exploder_stop("Dev Block strings are not supported");
		exploder::exploder("Dev Block strings are not supported");
		var_e1d12db4 = struct::get("Dev Block strings are not supported", "Dev Block strings are not supported");
...
function function_de755a0()
{
	/#
		...
		level flag::set("Dev Block strings are not supported");
		var_fc5fd994 = GetEntArray("Dev Block strings are not supported", "Dev Block strings are not supported");
		foreach(var_2c4603e5 in var_fc5fd994)
		{
			var_f93034eb = GetEnt(var_2c4603e5.target, "Dev Block strings are not supported");
			if(var_f93034eb.script_label == "Dev Block strings are not supported")
			{
				var_f93034eb clientfield::set("Dev Block strings are not supported", 1);
				util::wait_network_frame();
				var_f93034eb clientfield::set("Dev Block strings are not supported", 2);
			}
			else
			{
				var_f93034eb clientfield::set("Dev Block strings are not supported", 2);
...
function function_2d151482()
{
	/#
		...
		var_90cbeda9 = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
		var_90cbeda9 clientfield::set("Dev Block strings are not supported", 1);
		if(!(isdefined(level.var_2114a01) && level.var_2114a01))
		{
			zm_spawner::register_zombie_death_event_callback(&function_561017d8);
		}
		var_de75cc7c = GetEntArray("Dev Block strings are not supported", "Dev Block strings are not supported");
		foreach(var_7119a95d in var_de75cc7c)
		{
			var_7119a95d clientfield::set("Dev Block strings are not supported", 3);
		}
		level flag::set("Dev Block strings are not supported");
		level flag::set("Dev Block strings are not supported");
	#/
...
function function_3520622d(b_wait)
{
	...
	{
		var_b675d3f1 = var_cd45655b namespace_97ddfc0d::function_7c63dd65(var_300b5632, b_wait);
...
function function_686645ab()
{
	...
	while(1)
	{
		...
		if(e_who === level.var_6e68c0d8)
		{
			...
			var_cd45655b namespace_97ddfc0d::function_7b697614("vox_arro_demongate_ask_name_0");
		}
	}
}
...
{
	/#
		if(!level flag::get("Dev Block strings are not supported") || level flag::get("Dev Block strings are not supported") || level flag::get("Dev Block strings are not supported"))
		{
			return;
		}
		level flag::set("Dev Block strings are not supported");
		level notify("hash_32d99404");
		var_e488e3fa = struct::get_array("Dev Block strings are not supported", "Dev Block strings are not supported");
		foreach(var_e20408bb in var_e488e3fa)
		{
...
function function_695d82fd()
{
	...
	var_b35375be = util::spawn_model("tag_origin", var_e8294063, var_884470ed);
	var_b35375be clientfield::set("demongate_quest_portal", 1);
	/#
		level.var_a81ca85 = var_b35375be;
	#/
	...
	while(1)
	{
		...
		if(e_who === level.var_6e68c0d8)
		{
			...
			var_b35375be clientfield::set("demongate_quest_portal", 0);
	...
	level.var_72a6d56b Hide();
	level thread function_15894f24(var_b35375be);
...
function function_dc66bbef()
{
	/#
		...
		{
			var_7d849b98 = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
			var_7d849b98 clientfield::set("Dev Block strings are not supported", 1);
			var_e1f8771e = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
			var_e1f8771e scene::skipto_end("Dev Block strings are not supported");
		}
		if(isdefined(level.var_a81ca85))
		{
			level.var_a81ca85 clientfield::set("Dev Block strings are not supported", 0);
			wait(0.05);
		...
		var_90cbeda9 = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
		var_90cbeda9 delete();
		var_9d162495 = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
		var_9d162495 delete();
		var_7d849b98 = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
		var_7d849b98 delete();
		var_d8107c7c = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
		var_d8107c7c delete();
		var_f91a2b6a = GetEntArray("Dev Block strings are not supported", "Dev Block strings are not supported");
		Array::run_all(var_f91a2b6a, &delete);
		var_5b00744f = GetEntArray("Dev Block strings are not supported", "Dev Block strings are not supported");
		Array::run_all(var_5b00744f, &delete);
		var_6b525fd2 = GetEntArray("Dev Block strings are not supported", "Dev Block strings are not supported");
		Array::run_all(var_6b525fd2, &delete);
		zm_spawner::deregister_zombie_death_event_callback(&function_561017d8);
	#/
}
...
function function_8c23a1c7()
{
	/#
		...
		var_dfd1c443 = struct::get("Dev Block strings are not supported", "Dev Block strings are not supported");
		...
		level flag::set("Dev Block strings are not supported");
		var_dfd1c443.var_d4a62e6b = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
...
{
	/#
		var_18f50dca = struct::get_array("Dev Block strings are not supported", "Dev Block strings are not supported");
		foreach(var_48c991cb in var_18f50dca)
		{
			var_48c991cb.var_b5b31795 clientfield::set("Dev Block strings are not supported", 1);
		}
		level flag::set("Dev Block strings are not supported");
	#/
}
...
function function_2a8e7fe2()
{
	/#
		...
		level clientfield::set("Dev Block strings are not supported", function_85bfa3fd(level.var_52978d72.characterindex));
		level.var_427e7668[level.var_427e7668.size] = level.players[0];
		var_18f50dca = struct::get_array("Dev Block strings are not supported", "Dev Block strings are not supported");
		foreach(var_48c991cb in var_18f50dca)
		{
		...
		if(!(isdefined(level.var_e921c50c) && level.var_e921c50c))
		{
			level thread scene::skipto_end("Dev Block strings are not supported");
			level thread scene::skipto_end("Dev Block strings are not supported");
...
function function_15f112ea()
{
	/#
		wait(1);
		level.var_eee1576 = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
...
{
	/#
		if(!isdefined(level.var_e6d07014) || !level flag::get("Dev Block strings are not supported") || level flag::get("Dev Block strings are not supported"))
		{
			return;
		}
...
function function_a3638154()
{
	/#
		...
		{
			level.var_b9c00aec flag::set("Dev Block strings are not supported");
		}
	#/
}
...
function function_3429d04c()
{
	/#
		...
		level flag::set("Dev Block strings are not supported");
		var_affd5bec = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
		var_affd5bec show();
		zm_spawner::deregister_zombie_death_event_callback(&function_d0d62870);
...
function function_6c8179b7()
{
	/#
		level endon("hash_b12ab80e");
		var_dddbfe51 = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
		if(level flag::get("Dev Block strings are not supported") || level flag::get("Dev Block strings are not supported") || !level flag::get("Dev Block strings are not supported") || var_dddbfe51 flag::get("Dev Block strings are not supported"))
		{
			return;
		}
		level flag::set("Dev Block strings are not supported");
...
/*
	...
	Flags: None
*/
function function_1676aad7(n_delay, var_8cf5cf65)
{
...
function function_b6709ba6()
{
	/#
		...
		level flag::set("Dev Block strings are not supported");
		level flag::set("Dev Block strings are not supported");
		var_605e43a9 = struct::get("Dev Block strings are not supported", "Dev Block strings are not supported");
		...
		if(isdefined(level.var_e6d07014))
		{
			...
			level.var_e6d07014 clientfield::set("Dev Block strings are not supported", 0);
			level.var_e6d07014 clientfield::set("Dev Block strings are not supported", 0);
			wait(0.05);
			level.var_e6d07014 delete();
		}
...
function function_4bf5f2()
{
	/#
		...
		var_afd26121 = struct::get("Dev Block strings are not supported", "Dev Block strings are not supported");
		...
		level flag::set("Dev Block strings are not supported");
		var_afd26121.var_d4a62e6b = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
...
function function_2db350be()
{
	/#
		...
		level clientfield::set("Dev Block strings are not supported", function_85bfa3fd(level.var_f8d1dc16.characterindex));
		level.var_427e7668[level.var_427e7668.size] = level.players[0];
...
function function_9ad758f3()
{
	/#
		wait(1);
		level.var_18c771ad = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
...
function function_6e3cfa55()
{
	...
	var_a18380a7 = struct::get(self.target);
	while(1)
	{
		...
		{
			if(!isdefined(var_a18380a7.var_41f52afd))
			{
				var_a18380a7.var_41f52afd = util::spawn_model("tag_origin", var_a18380a7.origin);
			}
			var_a18380a7.var_41f52afd clientfield::set("beacon_fx", 1);
...
function function_c57b4999()
{
	/#
		...
		{
			level.var_a6503511 = level flag::get("Dev Block strings are not supported");
		}
		var_79b6dcfe = struct::get_array("Dev Block strings are not supported", "Dev Block strings are not supported");
		if(level.var_a6503511)
		{
			foreach(var_a18380a7 in var_79b6dcfe)
			{
				if(isdefined(var_a18380a7.var_41f52afd))
				{
					var_a18380a7.var_41f52afd clientfield::set("Dev Block strings are not supported", 0);
				}
			}
		...
		else
		{
			foreach(var_a18380a7 in var_79b6dcfe)
			{
				if(!isdefined(var_a18380a7.var_41f52afd))
				{
					var_a18380a7.var_41f52afd = util::spawn_model("Dev Block strings are not supported", var_a18380a7.origin);
				}
				var_a18380a7.var_41f52afd clientfield::set("Dev Block strings are not supported", 1);
			}
...
function function_7df3e31c()
{
	...
	{
		var_93e50579 = GetEnt(var_634fac89.target, "targetname");
...
function function_ba8e8ad8(e_who)
{
	...
	while(var_968c3922 < 4)
	{
		...
		else
		{
			var_968c3922++;
			/#
				IPrintLnBold("Dev Block strings are not supported" + var_968c3922 + "Dev Block strings are not supported");
			#/
		}
		wait(0.05);
	}
...
function function_5508467e()
{
	/#
		...
		level flag::set("Dev Block strings are not supported");
		var_5c7ef569 = GetEntArray("Dev Block strings are not supported", "Dev Block strings are not supported");
		foreach(var_634fac89 in var_5c7ef569)
		{
			var_93e50579 = GetEnt(var_634fac89.target, "Dev Block strings are not supported");
			var_93e50579 clientfield::set("Dev Block strings are not supported", 2);
			exploder::exploder("Dev Block strings are not supported" + var_634fac89.script_int);
		}
		level flag::set("Dev Block strings are not supported");
	#/
}
...
function function_1c758ab0()
{
	...
	while(1)
	{
		...
		if(isdefined(projectile.var_e4594d27) && projectile.var_e4594d27)
		{
			if(function_51a90202(weapon, 1, point, self))
			{
				var_a18380a7.var_41f52afd clientfield::set("beacon_fx", 2);
				self.var_d5d05f50 = 1;
				/#
					IPrintLnBold("Dev Block strings are not supported");
				#/
...
function function_4688cd22()
{
	...
	{
		if(self function_95cb9886() && self.chargeShotLevel === 4)
		{
	...
	/#
		...
		else
		{
			foreach(var_a18380a7 in var_79b6dcfe)
			{
				...
				var_a18380a7.var_41f52afd clientfield::set("Dev Block strings are not supported", 2);
			}
...
function function_ae42a737()
{
	/#
		...
		var_9e89bcdc = GetEntArray("Dev Block strings are not supported", "Dev Block strings are not supported");
		foreach(var_8f88d1fd in var_9e89bcdc)
		{
			var_a4f8e4d0 = GetEnt(var_8f88d1fd.targetname + "Dev Block strings are not supported", "Dev Block strings are not supported");
			var_a4f8e4d0.b_activated = 1;
			var_a4f8e4d0.var_c2733dc7 = 0;
			var_d186cfae = struct::get(var_8f88d1fd.target, "Dev Block strings are not supported");
			var_d186cfae.var_41f52afd clientfield::set("Dev Block strings are not supported", 2);
		}
		level flag::set("Dev Block strings are not supported");
		level flag::set("Dev Block strings are not supported");
	#/
...
function function_1ad44df5()
{
	/#
		...
		var_66b0cbbe = struct::get_array("Dev Block strings are not supported", "Dev Block strings are not supported");
		if(level.var_f3ff8b16)
		{
			foreach(var_d186cfae in var_66b0cbbe)
			{
				var_d186cfae.var_41f52afd clientfield::set("Dev Block strings are not supported", 1);
			}
			level.var_f3ff8b16 = 0;
		}
		else
...
function function_b1cac6d2()
{
	/#
		...
		foreach(var_d186cfae in var_66b0cbbe)
		{
			if(isdefined(var_d186cfae.var_41f52afd))
			{
				var_d186cfae.var_41f52afd clientfield::set("Dev Block strings are not supported", 0);
				var_d186cfae.var_41f52afd delete();
			}
		}
		zm_spawner::deregister_zombie_death_event_callback(&function_71e6353);
...
function function_1b2a8d00()
{
	/#
		...
		var_defe3942 = struct::get("Dev Block strings are not supported");
		if(level.var_e1c25eb8)
		{
			if(isdefined(var_defe3942.var_41f52afd))
			{
				var_defe3942.var_41f52afd clientfield::set("Dev Block strings are not supported", 0);
				var_defe3942.var_41f52afd clientfield::set("Dev Block strings are not supported", 0);
				level.var_e1c25eb8 = 0;
			}
		}
		...
		{
			var_defe3942.var_41f52afd = util::spawn_model("Dev Block strings are not supported", var_defe3942.origin, VectorScale((-1, 0, 0), 90));
		}
		var_defe3942.var_41f52afd clientfield::set("Dev Block strings are not supported", 1);
		var_defe3942.var_41f52afd clientfield::set("Dev Block strings are not supported", 1);
...
function function_71419e41()
{
	...
	foreach(var_a18380a7 in var_79b6dcfe)
	{
		var_a18380a7.var_41f52afd thread function_44dae424();
	}
	var_5c7ef569 = GetEntArray("aq_es_wallrun_trigger", "targetname");
	foreach(var_634fac89 in var_5c7ef569)
	{
...
function function_b88a3579()
{
	/#
		...
		var_fe3506f1 = struct::get("Dev Block strings are not supported", "Dev Block strings are not supported");
		...
		level flag::set("Dev Block strings are not supported");
		var_fe3506f1.var_d4a62e6b = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
...
function function_655cb8e()
{
	while(1)
	{
		...
		else if(isdefined(e_who) && Array::contains(level.var_427e7668, e_who))
		{
			e_who notify("hash_477375c9");
			level function_7910311b(e_who);
			e_who playsound("zmb_broken_arrow_pickup");
...
function function_42084ad5(var_e459d8fb)
{
	...
	/#
		level endon("Dev Block strings are not supported" + var_1493eda1 + "Dev Block strings are not supported");
	#/
...
function function_7bbe3a25()
{
	/#
		...
		{
			var_1493eda1 = "Dev Block strings are not supported";
			var_78cede1 = "Dev Block strings are not supported";
			level.var_6e68c0d8 = undefined;
		}
		...
		level clientfield::set(var_78cede1, 0);
		level notify("Dev Block strings are not supported" + var_1493eda1 + "Dev Block strings are not supported");
...
function function_14dd5ea5()
{
	...
	{
		self.var_67b5dd94 waittill("trigger", e_who);
		var_186e36e = level function_7b6fdb3e(self.script_label);
		if(e_who === var_186e36e)
		{
	...
	self thread function_fb704679(var_186e36e);
	var_491b9e06 = var_1493eda1 + "_spawned";
...
{
	/#
		level scene::stop("Dev Block strings are not supported", 1);
		level scene::stop("Dev Block strings are not supported", 1);
		level scene::stop("Dev Block strings are not supported", 1);
		level scene::stop("Dev Block strings are not supported", 1);
		exploder::exploder("Dev Block strings are not supported");
		...
		level thread scene::Play("Dev Block strings are not supported");
		level scene::Play("Dev Block strings are not supported");
		var_682d4b77 = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
		var_682d4b77 thread function_bf26d3fb("Dev Block strings are not supported");
		var_5d79f228 = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
		var_5d79f228 thread function_bf26d3fb("Dev Block strings are not supported");
		var_3133abfb = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
		var_3133abfb thread function_bf26d3fb("Dev Block strings are not supported");
		var_48ce3e52 = GetEnt("Dev Block strings are not supported", "Dev Block strings are not supported");
		var_48ce3e52 thread function_bf26d3fb("Dev Block strings are not supported");
...
/*
	...
	Flags: None
*/
function function_fb704679(var_186e36e)
{
	if(!isdefined(var_186e36e))
	{
		var_186e36e = undefined;
	}
	if(isdefined(var_186e36e))
	{
		var_186e36e notify("hash_ea0c887b");
	...
	while(1)
	{
		...
		var_186e36e = level function_7b6fdb3e(self.script_label);
		if(e_who function_5facaaf9(var_186e36e, self.script_label))
		{
			if(e_who HasWeapon(GetWeapon("elemental_bow")))
			{
				e_who zm_weapons::weapon_take(GetWeapon("elemental_bow"));
			...
			{
				var_8ea4a872 = e_who GetWeaponsListPrimaries();
				if(var_8ea4a872.size >= 3)
				{
					for(i = 2; i < var_8ea4a872.size; i++)
					{
						if(var_8ea4a872[i] == var_b4810425)
						{
...
function function_a4861409(e_player, var_285c992d)
{
	...
	while(1)
	{
		...
		else if(str_notify == "bgb_about_to_take_on_bled_out")
		{
...
/*
	...
	Flags: None
*/
function function_5facaaf9(var_186e36e, str_weapon_name)
{
	if(isdefined(var_186e36e))
	{
		if(self === var_186e36e)
		{
			ArrayRemoveValue(level.var_427e7668, var_186e36e);
...
function function_7b6fdb3e(var_1493eda1)
{
	switch(var_1493eda1)
	{
		case "elemental_bow_rune_prison":
		{
			var_186e36e = level.var_c62829c7;
			break;
		}
		case "elemental_bow_demongate":
		{
			var_186e36e = level.var_6e68c0d8;
			break;
		}
		case "elemental_bow_wolf_howl":
		{
			var_186e36e = level.var_52978d72;
			break;
		}
		case "elemental_bow_storm":
		{
			var_186e36e = level.var_f8d1dc16;
			break;
		}
	}
	return var_186e36e;
...
function function_55c48922(v_origin, v_target, var_25c1c42e, var_7364b0dd)
{
	...
	var_61ef7fda = "zombie_soul_" + var_25c1c42e + "_fx";
	if(!var_7364b0dd)
	{
		v_origin = v_origin + VectorScale((0, 0, 1), 48);
	}
	v_angles = VectorToAngles(v_target - v_origin);
	var_b35375be = util::spawn_model("tag_origin", v_origin, v_angles);
	var_b35375be playsound("zmb_ee_soul_start");
	var_b35375be PlayLoopSound("zmb_ee_soul_lp");
	var_b35375be clientfield::set(var_61ef7fda, 1);
	var_b35375be moveto(v_target, 1.75, 0.75);
	var_b35375be waittill("movedone");
	var_b35375be playsound("zmb_ee_soul_impact");
	level notify("hash_d8b279ab");
	var_b35375be clientfield::set(var_61ef7fda, 0);
	wait(0.05);
	var_b35375be delete();
}
...
{
	var_186e36e = level function_7b6fdb3e(self.stub.str_weapon);
	self setHintString(&"");
	if(e_player === var_186e36e)
	{
		return 1;
	}
	return 0;
...
{
	var_186e36e = function_7b6fdb3e(self.stub.str_weapon);
	if(isdefined(var_186e36e))
	{
		if(e_player == var_186e36e)
		{
...
function function_952cba55()
{
	/#
		...
		wait(1);
		zm_devgui::function_4acecab5(&function_50564c39);
		zm_devgui::function_4acecab5(&function_23e16ccd);
		zm_devgui::function_4acecab5(&function_f31ec4b7);
		zm_devgui::function_4acecab5(&function_5a256cec);
		zm_devgui::function_4acecab5(&function_144e821b);
