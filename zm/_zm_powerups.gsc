...
function print_powerup_drop(powerup, type)
{
	/#
		...
		println("Dev Block strings are not supported");
		println("Dev Block strings are not supported" + powerup);
		println("Dev Block strings are not supported" + type);
		println("Dev Block strings are not supported");
		println("Dev Block strings are not supported" + time);
		println("Dev Block strings are not supported" + level.powerup_random_count);
		println("Dev Block strings are not supported" + level.powerup_score_count);
		println("Dev Block strings are not supported");
	#/
}
